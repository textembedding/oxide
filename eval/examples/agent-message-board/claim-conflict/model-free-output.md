...
source_specifications = [
  { path = "eval/examples/agent-message-board/claim-conflict/specs/PRODUCT.md", anchor = "7.2 Claim winner", requirement = "The earliest valid Claim by BoardSeq is the unique winner for its claim key and generation." },
