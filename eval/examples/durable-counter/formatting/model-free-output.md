...
source_specifications = [
  { path = "eval/examples/durable-counter/formatting/specs/PRODUCT.md", anchor = "Updates", requirement = "A client may add a signed 64-bit delta to a named counter." },
  { path = "eval/examples/durable-counter/formatting/specs/PRODUCT.md", anchor = "Updates", requirement = "An update that would overflow the signed 64-bit range is rejected without changing the counter." },
